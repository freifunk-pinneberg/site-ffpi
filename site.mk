...
GLUON_TLWDR4300_SITE_PACKAGES := $(USB_PACKAGES_BASIC) $(USB_PACKAGES_3G) $(USB_PACKAGES_GPS)
GLUON_TLWR1043_SITE_PACKAGES := $(USB_PACKAGES_BASIC) $(USB_PACKAGES_3G) $(USB_PACKAGES_GPS)
GLUON_TLWR2543_SITE_PACKAGES := $(USB_PACKAGES_BASIC)
GLUON_TLWR842_SITE_PACKAGES := $(USB_PACKAGES_BASIC) $(USB_PACKAGES_3G) $(USB_PACKAGES_GPS)
...
DEFAULT_GLUON_RELEASE := 0.8.1+exp$(shell date '+%Y%m%d')
